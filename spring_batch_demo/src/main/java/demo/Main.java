...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        flatFileItemReader.setResource(new FileSystemResource("spring_batch_demo/src/main/resources/batch-data.csv"));
        flatFileItemReader.setLineMapper(new HelloLineMapper());    // 进行分词 1
        ...
        flatFileItemWriter.setResource(new FileSystemResource("spring_batch_demo/src/main/resources/batch-data1.csv"));
